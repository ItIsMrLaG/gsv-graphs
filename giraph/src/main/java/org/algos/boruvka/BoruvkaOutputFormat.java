...
public class BoruvkaOutputFormat
    ...
    @Override
    public TextVertexOutputFormat<IntWritable, BoruvkaVertexValue, EdgeMeta>.TextVertexWriter createVertexWriter(TaskAttemptContext context) throws IOException, InterruptedException {
