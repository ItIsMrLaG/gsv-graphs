 ...
 * <p>
 * 1. To specify source vertices file (file will be available via DistributedCache):
 * <pre>{@code
 *  -cf /path/to/source_nodes.txt
 * }</pre>
 *
 * <p>
 * 2. To use custom worker context:
 * <pre>{@code
 *  -wc org.algos.msbfs.MSBFSWorkerContext
 * }</pre>
 *
 * <p>
 * 3. /path/to/source_nodes.txt format:
 * <pre>{@code
 *  start_id1
 *  start_id2
 *  start_id3
 ...
 * @see <a href="https://github.com/apache/giraph/blob/trunk/giraph-examples/src/main/java/org/apache/giraph/examples/RandomWalkWorkerContext.java">
 *      RandomWalkWorkerContext (reference implementation)
 *      </a>
 */
public class MSBFSWorkerContext extends WorkerContext {
    ...
    private static final Logger LOG = Logger
            .getLogger(MSBFSWorkerContext.class);
